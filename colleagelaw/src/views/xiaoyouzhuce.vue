<template>
  ...
  <el-form label-width="70px" class="login-container" :model="form" :rules="rules" :inline="true" ref="form" > <!--inline表示label和表单输入框在同一行-->
        ...
        <el-form-item prop="phone" label="手机号"> <!--prop的内容要和rules里相应的字段名一一对应-->
            <el-input v-model="form.phone" palceholder="请输入账号,只能包含大小写字母和数字组合" v-int></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="password">
            <el-input v-model="form.password" palceholder="请输入密码" type="password"></el-input>
        </el-form-item>
        <el-form-item label="用户名" prop="username" >
            <el-input v-model="form.username" palceholder="请输入密码" ></el-input>
        </el-form-item>
        <el-form-item label="专业" prop="department" >
            <el-input v-model="form.department" palceholder="请输入密码" ></el-input>
        </el-form-item>
    ...
    data() {
      ...
      return {  
        ...
        rules:{
          phone:[
            {
              min:10,max:11,message:'手机号码格式不对',trigger: 'blur', required:true
            }
          ],
         password:[
        ...
        username:[
          ...
          {
            min:2,max:10,message:'输入内容长度在2到10个字符',trigger: 'blur', required:true
          },
        ...
        department:[
            {
              min:3,max:10,message:'输入内容长度在3到10个字符',trigger:'blur', required:true
            }
          ]
        }
      }
