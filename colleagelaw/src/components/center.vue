<template>
    <div class="card" id="centera">
    <el-card >
    <el-form label-width="70px" class="login-container" :model="form" :rules="rules" :inline="true" ref="form"> <!--inline表示label和表单输入框在同一行-->
          <slot name="title"></slot>
          <el-form-item prop="oldPwd" label="旧密码"> <!--prop的内容要和rules里相应的字段名一一对应-->
              <el-input v-model="form.oldPwd" palceholder="请输入旧密码" 
    ></el-input>
          </el-form-item>
          <el-form-item label="新密码" prop="newPwd">
              <el-input v-model="form.newPwd" palceholder="请输入新密码" type="password"></el-input>
          </el-form-item>
          <el-form-item>
              <el-button @click="submit('form')" type="primary" class="submit">确认</el-button>
          </el-form-item>
      </el-form>
      ...
      data() {
        ...
        newPwd:''
          ...
          rules:{
            oldPwd:[
              {
                min:5,max:15,message:'长度在5到15个字符之间',trigger: 'blur',required:true
              },
              {
